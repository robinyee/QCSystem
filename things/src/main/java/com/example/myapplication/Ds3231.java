...
/*
import static Ds3231.SquareWaveOutputFrequency.FREQUENCY_1024_HZ;
import static Ds3231.SquareWaveOutputFrequency.FREQUENCY_1_HZ;
import static Ds3231.SquareWaveOutputFrequency.FREQUENCY_4096_HZ;
import static Ds3231.SquareWaveOutputFrequency.FREQUENCY_8192_HZ;
*/
/**
...
public class Ds3231 implements Closeable {
    ...
    public int getSquareWaveOutputFrequency() throws IOException {
        return (readRegByte(RTC_CONTROL_REG) & 0xFF) & SquareWaveOutputFrequency.FREQUENCY_8192_HZ;
    ...
    public void setSquareWaveOutputFrequency(@SquareWaveOutputFrequency int squareWaveOutputFrequency) throws
            IOException {
        byte reg = readRegByte(RTC_CONTROL_REG);
        reg &= ~(SquareWaveOutputFrequency.FREQUENCY_8192_HZ);
    ...
    @IntDef({SquareWaveOutputFrequency.FREQUENCY_1_HZ,
            SquareWaveOutputFrequency.FREQUENCY_1024_HZ,
